 ...
 * @author Iproy
 */
public class ResultadosGetView extends javax.swing.JFrame {

    String resultados;
    public ResultadosGetView(String resultadosGet) {
        resultados = resultadosGet;
        initComponents();
        resultadosTextArea.setText(resultados);
    }
    
    public ResultadosGetView(){
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadosGetView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultadosGetView().setVisible(true);
            }
        });
    }
